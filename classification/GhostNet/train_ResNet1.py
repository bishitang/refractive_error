...
class Trainer:
    ...
    def train(self, stop_value):
        ...
        log_dir = os.path.join("./logs/ghostnet/", current_time)
            ...
            if epoch % 1 == 0 or epoch == stop_value:
                ...
                with torch.no_grad():
                    ...
                    save_path_acc = os.path.join(
                        r'D:\shishai\model\github\refractive_error\classification\GhostNet\params',
                        f'ghostnet_val_acc_{val_acc:.3f}_{avg_val_loss:.3f}_epoch{epoch}.plt'
                    )
