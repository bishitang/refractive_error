...
class Tester:
    def __init__(self, model, model_copy):
        ...
        if os.path.exists(self.model):
            ...
            self.net = torch.load(self.model).to(self.device)
...
if __name__ == '__main__':
    PATH = r"D:\shishai\Primary_school_data\data_version_3\images"

    f = open(r"D:\shishai\Primary_school_data\data_version_3\pair_test_RL.txt", encoding='gbk')
    # 路径改一下
    t = Tester(r'./params/model_1480_0.70703125_2.184291362762451.plt', r'./model_{}_{}.plt')
