...
class GhostNet(nn.Module):
    def __init__(self, cfgs, num_classes=2, width=1.0, dropout=0.2, block=GhostBottleneck, args=None):
...
def ghostnetv3(**kwargs):
    ...
    return GhostNet(cfgs, num_classes=2, width=kwargs['width'], dropout=0.2)
...
if __name__ == '__main__':
    ...
    # model.eval()
    # print(model)
    # input1 = torch.randn(32, 18, 320, 256)
    # input2 = torch.randn(32, 18, 256, 320)
    # input3 = torch.randn(32, 18, 224, 224)
    #
